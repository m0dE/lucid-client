...
const schema = yup.object().shape({
  additionalTimeCredit: yupFormSchemas.integer(
    i18n('entities.userSettings.fields.additionalTimeCredit'),
    {},
  ),
  monthlyTimeCredit: yupFormSchemas.integer(
...
function UserSettingsForm(props) {
  ...
  const [initialValues] = useState(() => {
    ...
    return {
      additionalTimeCredit: record.additionalTimeCredit,
      monthlyTimeCredit: record.monthlyTimeCredit,
    };
  });
